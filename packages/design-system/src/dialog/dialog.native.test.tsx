...
// dialog.native.tsx and renders it through react-native-web, the pair a React Native
// consumer ships on web. react-native-web's Modal renders a portal into the document,
