...
# (no local emulator). The final step chains unconditionally
...
#
# Usage:
#   ./services/api/scripts/dev-setup.sh            # uses the default AWS profile
#   ./services/api/scripts/dev-setup.sh --yes
