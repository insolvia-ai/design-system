...
This service needs machine-queryable request logs in CloudWatch, so it renders
every stdlib log record as one JSON object per line. The formatter is plain stdlib
