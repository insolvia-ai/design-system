...
// runs inside *every* subdirectory — including any that arrives later with its
// own ESLint setup.
//
// This bit once, for real, in the monorepo this package came from: a root
// `eslint.config.js` flipped a since-retired package's own eslintrc-based
// ESLint 8 run into flat-config mode, and its required check went red for a
...
// reasoning. `packages/tokens/src/tokens.ts` is linted like any other source,
// and the generator emits bytes that satisfy it.
